import React, { useState, useMemo, useCallback, useEffect , useRef} from 'react';
  ...
  const initialValue = { id_client_dechet:"", quantite:"", montant_total:"", date_commande:"", date_livraison:"",created_at:"", updated_at:""}  
  function CommandeDechet() {
    ...
    const columnDefs = [
      ...
      { headerName: "id client", field: "id_client_dechet"},
    ...
    return (
      ...
      <h2 align="center">Commandes</h2>
        ...
        <DialogCommandeDechet open={open} handleClose={handleClose}
          data={formData} onChange={onChange} handleFormSubmit={handleFormSubmit} />
      </div>
    );
  }
  
  export default CommandeDechet;