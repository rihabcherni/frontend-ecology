  ...
  function ZoneDepots() {
    ...
    const columnDefs = [
      ...
      { headerName: "quantite_depot_maximale", field: "quantite_depot_maximale"},
      { headerName: "quantite_depot_actuelle_plastique", field: "quantite_depot_actuelle_plastique"},
      { headerName: "quantite_depot_actuelle_papier", field: "quantite_depot_actuelle_papier"},
      { headerName: "quantite_depot_actuelle_composte", field: "quantite_depot_actuelle_composte"},
      { headerName: "quantite_depot_actuelle_canette", field: "quantite_depot_actuelle_canette"},
    ...
    return (
      ...
      <h2 align="center">Zone Depots</h2>
        ...
        <DialogZoneDepot open={open} handleClose={handleClose}
          data={formData} onChange={onChange} handleFormSubmit={handleFormSubmit} />
      </div>
    );
  }
  
  export default ZoneDepots;
