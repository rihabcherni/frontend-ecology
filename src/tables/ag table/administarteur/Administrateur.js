...
function Administrateur() {
  ...
  const columnDefs = [
    ...
    { headerName: "photo", field: "photo",  cellRenderer: (params) =><img  src={"public/storage/images/gestionnaire/"+params.data.photo} />},
  ...
  <div className="ag-theme-alpine" style={{ height: '350px'}}>
      ...
      <DialogAdmin open={open} handleClose={handleClose}
