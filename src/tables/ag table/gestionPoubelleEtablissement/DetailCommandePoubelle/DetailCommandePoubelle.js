...
export default function DetailCommandePoubelle() {
  ...
  const columnDefs = [
    ...
    { headerName: "id_stock_poubelle", field: "id_stock_poubelle", },
    { headerName: "quantite", field: "quantite", },
    { headerName: "prix_unitaires", field: "prix_unitaires", },
  ...
  <div className="ag-theme-alpine" style={{ height: '350px'}}>
      ...
      <DialogDetailCommandePoubelle open={open} handleClose={handleClose}
