...
export default function CommandePoubelle() {
  ...
  const columnDefs = [
    ...
    { headerName: "id_responsable_etablissement", field: "id_responsable_etablissement", },
    { headerName: "quantite", field: "quantite", },
    { headerName: "montant_total", field: "montant_total", },
    { headerName: "date_commande", field: "date_commande", },
    { headerName: "date_livraison", field: "date_livraison", },
  ...
  <div className="ag-theme-alpine" style={{ height: '350px'}}>
      ...
      <DialogCommandePoubelle open={open} handleClose={handleClose}
