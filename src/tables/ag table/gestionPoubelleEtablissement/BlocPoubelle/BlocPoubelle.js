...
import DialogBlocPoubelle from './DialogBlocPoueblle';
import {Item} from '../../../../components/Item'

const initialValue = { id_etablissement: "", emplacement: ""}
function BlocPoubelle() {
  ...
  const columnDefs = [
    ...
    { headerName: "emplacement", field: "emplacement", },
  ...
  <div className="ag-theme-alpine" style={{ height: '350px'}}>
      ...
      <DialogBlocPoubelle open={open} handleClose={handleClose}
      data={formData} onChange={onChange} handleFormSubmit={handleFormSubmit} />
  </div>
  );
}

export default BlocPoubelle;