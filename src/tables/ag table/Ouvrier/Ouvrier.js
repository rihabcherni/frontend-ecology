...
const initialValue = { id_etablissement:"", id_camion:"", poste:"", nom:"",prenom:"",numero_tel:"",email:"",mot_de_passe:"",created_at:"", updated_at:""}
function Ouvrier() {
  ...
  const columnDefs = [
    ...
    { headerName: "id etablissement", field: "id_etablissement"},
    { headerName: "id camion", field: "id_camion"},
    { headerName: "poste", field: "poste"},
    { headerName: "nom", field: "nom"},
    { headerName: "prenom", field: "prenom"},
    { headerName: "numero_tel", field: "numero_tel" },
  ...
  return (
    ...
    <h2 align="center">Ouvrier</h2>
      ...
      <DialogOuvrier open={open} handleClose={handleClose}
