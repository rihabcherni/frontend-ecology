...
export default function StockPoubelle() {
  ...
  const columnDefs = [
    ...
    { headerName: "quantite_disponible_plastique", field: "quantite_disponible_plastique", },
    { headerName: "quantite_disponible_canette", field: "quantite_disponible_canette", },
    { headerName: "quantite_disponible_composte", field: "quantite_disponible_composte", },
    { headerName: "quantite_disponible_papier", field: "quantite_disponible_papier", },
  ...
  <div className="ag-theme-alpine" style={{ height: '350px'}}>
      ...
      <DialogStockPoubelle open={open} handleClose={handleClose}
