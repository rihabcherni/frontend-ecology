import React, { useState, useMemo, useCallback, useEffect , useRef} from 'react';
  ...
  const initialValue = { id_client:"", quantite:"", prix:"", date_commande:"", date_livraison:"",created_at:"", updated_at:""}
  function Commande() {
    ...
    const columnDefs = [
      ...
      { headerName: "id client", field: "id_client"},
    ...
    return (
      ...
      <h2 align="center">Commandes</h2>
        ...
        <DialogCommande open={open} handleClose={handleClose}
